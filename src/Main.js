...
class Main extends React.Component {
    render() {
        return (
            <>
            {/* for (let i=0; i<array.arrayOfHornedBeast.length; i++) {
               for (var key in array.arrayOfHornedBeast[i]) {
                ...
                <HornedBeast title={arrayOfHornedBeast[0].title} image_url={arrayOfHornedBeast[0].image_url} description={arrayOfHornedBeast[0].description} />
                <HornedBeast title={arrayOfHornedBeast[1].title} image_url={arrayOfHornedBeast[1].image_url} description={arrayOfHornedBeast[1].description} />
                <HornedBeast title={arrayOfHornedBeast[2].title} image_url={arrayOfHornedBeast[2].image_url} description={arrayOfHornedBeast[2].description} />
                <HornedBeast title={arrayOfHornedBeast[3].title} image_url={arrayOfHornedBeast[3].image_url} description={arrayOfHornedBeast[3].description} />
                <HornedBeast title={arrayOfHornedBeast[4].title} image_url={arrayOfHornedBeast[4].image_url} description={arrayOfHornedBeast[4].description} />
                <HornedBeast title={arrayOfHornedBeast[5].title} image_url={arrayOfHornedBeast[5].image_url} description={arrayOfHornedBeast[5].description} />
                <HornedBeast title={arrayOfHornedBeast[6].title} image_url={arrayOfHornedBeast[6].image_url} description={arrayOfHornedBeast[6].description} />
                <HornedBeast title={arrayOfHornedBeast[7].title} image_url={arrayOfHornedBeast[7].image_url} description={arrayOfHornedBeast[7].description} />
                <HornedBeast title={arrayOfHornedBeast[8].title} image_url={arrayOfHornedBeast[8].image_url} description={arrayOfHornedBeast[8].description} />
                <HornedBeast title={arrayOfHornedBeast[9].title} image_url={arrayOfHornedBeast[9].image_url} description={arrayOfHornedBeast[9].description} />
                <HornedBeast title={arrayOfHornedBeast[10].title} image_url={arrayOfHornedBeast[10].image_url} description={arrayOfHornedBeast[10].description} />
                <HornedBeast title={arrayOfHornedBeast[11].title} image_url={arrayOfHornedBeast[11].image_url} description={arrayOfHornedBeast[11].description} />
                <HornedBeast title={arrayOfHornedBeast[12].title} image_url={arrayOfHornedBeast[12].image_url} description={arrayOfHornedBeast[12].description} />
                <HornedBeast title={arrayOfHornedBeast[13].title} image_url={arrayOfHornedBeast[13].image_url} description={arrayOfHornedBeast[13].description} />
                <HornedBeast title={arrayOfHornedBeast[14].title} image_url={arrayOfHornedBeast[14].image_url} description={arrayOfHornedBeast[14].description} />
                <HornedBeast title={arrayOfHornedBeast[15].title} image_url={arrayOfHornedBeast[15].image_url} description={arrayOfHornedBeast[15].description} />
                <HornedBeast title={arrayOfHornedBeast[16].title} image_url={arrayOfHornedBeast[16].image_url} description={arrayOfHornedBeast[16].description} />
                <HornedBeast title={arrayOfHornedBeast[17].title} image_url={arrayOfHornedBeast[17].image_url} description={arrayOfHornedBeast[17].description} />
                <HornedBeast title={arrayOfHornedBeast[18].title} image_url={arrayOfHornedBeast[18].image_url} description={arrayOfHornedBeast[18].description} />
                <HornedBeast title={arrayOfHornedBeast[19].title} image_url={arrayOfHornedBeast[19].image_url} description={arrayOfHornedBeast[19].description} />
            </>
